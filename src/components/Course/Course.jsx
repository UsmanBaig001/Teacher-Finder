      ...
      <div className="blog-container" id="blog">
        <div className="blog-head">
          <div className="blog-head-left"> 
            ...
            <h2>
              We're here to share <span> Courses </span> from the <span>latest</span>
            </h2>
          </div>
          <div className="blog-head-right">
            <Link to={'/courses'} className="primary-btn discover" style={{fontSize:'12px'}}>View All Courses</Link>
          </div>
        </div>
